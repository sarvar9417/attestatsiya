...
export const MODULES: Module[] = [
  {
    ...
    description: 'Informatika, ma\'lumot, axborot va bilim; axborot turlari, xossalari va manbalari; axborot jarayonlari, izlash va raqamli madaniyat; belgi, kod va axborot hajmi; matn, grafika, audio va videoning raqamli tasvirlanishi; hisoblash strategiyasi va attestatsiya diagnostikasi.',
    section: 'specialty', examQuestionCount: 3,
    subtopics: [
      { id: 'M01.01', title: 'Qo‘llanmadan qanday foydalaniladi?' },
      { id: 'M01.02', title: 'Informatika, ma\'lumot, axborot va bilim' },
      { id: 'M01.03', title: 'Axborotning turlari, shakllari, xossalari va manbalari' },
      { id: 'M01.04', title: 'Axborot jarayonlari, izlash va raqamli madaniyat' },
      { id: 'M01.05', title: 'Belgi, kod, kodlash va axborot hajmi' },
      { id: 'M01.06', title: 'Matn, grafika, audio va videoning raqamli tasvirlanishi' },
      { id: 'M01.07', title: 'Axborot hajmini hisoblashning yagona strategiyasi' },
      { id: 'M01.08', title: 'Attestatsiyadagi nozik farqlar va diagnostika' },
      { id: 'M01.09', title: 'Bir qarashda: formulalar va birliklar' },
      { id: 'M01.10', title: 'Boblar bo\'yicha A–E diagnostika' },
      { id: 'M01.11', title: 'Atamalar lug‘ati' },
      { id: 'M01.12', title: 'Birlashtirish qamrovi va manba reyestri' },
    ],
  },
  {
    id: 'M02', code: 'M02',
